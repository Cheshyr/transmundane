	...
	if Signature(e) = 'BOOK' then
		...
		if ReferencedByCount(e) > 0 then
			...
			//	if GetElementEditValues(spell, 'SPIT\Type') = 'Spell' then
				...
				if GetElementEditValues(spell, 'SPIT\Half-cost Perk') = 'NULL - Null Reference [00000000]' then Spell_School_Skill_List.Add(IntToHex(FixedFormID(spell), 8) + ';-1;-1;' + GetElementEditValues(spell, 'FULL'));
				
				if GetElementEditValues(spell, 'SPIT\Half-cost Perk') = 'AlterationNovice00 "Novice Alteration" [PERK:000F2CA6]' then Spell_School_Skill_List.Add(IntToHex(FixedFormID(spell), 8) + ';Alteration;0;' + GetElementEditValues(spell, 'FULL'));
				if GetElementEditValues(spell, 'SPIT\Half-cost Perk') = 'AlterationApprentice25 "Apprentice Alteration" [PERK:000C44B7]' then Spell_School_Skill_List.Add(IntToHex(FixedFormID(spell), 8) + ';Alteration;25;' + GetElementEditValues(spell, 'FULL'));
				if GetElementEditValues(spell, 'SPIT\Half-cost Perk') = 'AlterationAdept50 "Adept Alteration" [PERK:000C44B8]' then Spell_School_Skill_List.Add(IntToHex(FixedFormID(spell), 8) + ';Alteration;50;' + GetElementEditValues(spell, 'FULL'));
				if GetElementEditValues(spell, 'SPIT\Half-cost Perk') = 'AlterationExpert75 "Expert Alteration" [PERK:000C44B9]' then Spell_School_Skill_List.Add(IntToHex(FixedFormID(spell), 8) + ';Alteration;75;' + GetElementEditValues(spell, 'FULL'));
				if GetElementEditValues(spell, 'SPIT\Half-cost Perk') = 'AlterationMaster100 "Master Alteration" [PERK:000C44BA]' then Spell_School_Skill_List.Add(IntToHex(FixedFormID(spell), 8) + ';Alteration;100;' + GetElementEditValues(spell, 'FULL'));
				
				if GetElementEditValues(spell, 'SPIT\Half-cost Perk') = 'ConjurationNovice00 "Novice Conjuration" [PERK:000F2CA7]' then Spell_School_Skill_List.Add(IntToHex(FixedFormID(spell), 8) + ';Conjuration;0;' + GetElementEditValues(spell, 'FULL'));
				if GetElementEditValues(spell, 'SPIT\Half-cost Perk') = 'ConjurationApprentice25 "Apprentice Conjuration" [PERK:000C44BB]' then Spell_School_Skill_List.Add(IntToHex(FixedFormID(spell), 8) + ';Conjuration;25;' + GetElementEditValues(spell, 'FULL'));
				if GetElementEditValues(spell, 'SPIT\Half-cost Perk') = 'ConjurationAdept50 "Adept Conjuration" [PERK:000C44BC]' then Spell_School_Skill_List.Add(IntToHex(FixedFormID(spell), 8) + ';Conjuration;50;' + GetElementEditValues(spell, 'FULL'));
				if GetElementEditValues(spell, 'SPIT\Half-cost Perk') = 'ConjurationExpert75 "Expert Conjuration" [PERK:000C44BD]' then Spell_School_Skill_List.Add(IntToHex(FixedFormID(spell), 8) + ';Conjuration;75;' + GetElementEditValues(spell, 'FULL'));
				if GetElementEditValues(spell, 'SPIT\Half-cost Perk') = 'ConjurationMaster100 "Master Conjuration" [PERK:000C44BE]' then Spell_School_Skill_List.Add(IntToHex(FixedFormID(spell), 8) + ';Conjuration;100;' + GetElementEditValues(spell, 'FULL'));
				
				if GetElementEditValues(spell, 'SPIT\Half-cost Perk') = 'DestructionNovice00 "Novice Destruction" [PERK:000F2CA8]' then Spell_School_Skill_List.Add(IntToHex(FixedFormID(spell), 8) + ';Destruction;0;' + GetElementEditValues(spell, 'FULL'));
				if GetElementEditValues(spell, 'SPIT\Half-cost Perk') = 'DestructionApprentice25 "Apprentice Destruction" [PERK:000C44BF]' then Spell_School_Skill_List.Add(IntToHex(FixedFormID(spell), 8) + ';Destruction;25;' + GetElementEditValues(spell, 'FULL'));
				if GetElementEditValues(spell, 'SPIT\Half-cost Perk') = 'DestructionAdept50 "Adept Destruction" [PERK:000C44C0]' then Spell_School_Skill_List.Add(IntToHex(FixedFormID(spell), 8) + ';Destruction;50;' + GetElementEditValues(spell, 'FULL'));
				if GetElementEditValues(spell, 'SPIT\Half-cost Perk') = 'DestructionExpert75 "Expert Destruction" [PERK:000C44C1]' then Spell_School_Skill_List.Add(IntToHex(FixedFormID(spell), 8) + ';Destruction;75;' + GetElementEditValues(spell, 'FULL'));
				if GetElementEditValues(spell, 'SPIT\Half-cost Perk') = 'DestructionMaster100 "Master Destruction" [PERK:000C44C2]' then Spell_School_Skill_List.Add(IntToHex(FixedFormID(spell), 8) + ';Destruction;100;' + GetElementEditValues(spell, 'FULL'));
				
				if GetElementEditValues(spell, 'SPIT\Half-cost Perk') = 'IllusionNovice00 "Novice Illusion" [PERK:000F2CA9]' then Spell_School_Skill_List.Add(IntToHex(FixedFormID(spell), 8) + ';Illusion;0;' + GetElementEditValues(spell, 'FULL'));
				if GetElementEditValues(spell, 'SPIT\Half-cost Perk') = 'IllusionApprentice25 "Apprentice Illusion" [PERK:000C44C3]' then Spell_School_Skill_List.Add(IntToHex(FixedFormID(spell), 8) + ';Illusion;25;' + GetElementEditValues(spell, 'FULL'));
				if GetElementEditValues(spell, 'SPIT\Half-cost Perk') = 'IllusionAdept50 "Adept Illusion" [PERK:000C44C4]' then Spell_School_Skill_List.Add(IntToHex(FixedFormID(spell), 8) + ';Illusion;50;' + GetElementEditValues(spell, 'FULL'));
				if GetElementEditValues(spell, 'SPIT\Half-cost Perk') = 'IllusionExpert75 "Expert Illusion" [PERK:000C44C5]' then Spell_School_Skill_List.Add(IntToHex(FixedFormID(spell), 8) + ';Illusion;75;' + GetElementEditValues(spell, 'FULL'));
				if GetElementEditValues(spell, 'SPIT\Half-cost Perk') = 'IllusionMaster100 "Master Illusion" [PERK:000C44C6]' then Spell_School_Skill_List.Add(IntToHex(FixedFormID(spell), 8) + ';Illusion;100;' + GetElementEditValues(spell, 'FULL'));
				
				if GetElementEditValues(spell, 'SPIT\Half-cost Perk') = 'RestorationNovice00 "Novice Restoration" [PERK:000F2CAA]' then Spell_School_Skill_List.Add(IntToHex(FixedFormID(spell), 8) + ';Restoration;0;' + GetElementEditValues(spell, 'FULL'));
				if GetElementEditValues(spell, 'SPIT\Half-cost Perk') = 'RestorationApprentice25 "Apprentice Restoration" [PERK:000C44C7]' then Spell_School_Skill_List.Add(IntToHex(FixedFormID(spell), 8) + ';Restoration;25;' + GetElementEditValues(spell, 'FULL'));
				if GetElementEditValues(spell, 'SPIT\Half-cost Perk') = 'RestorationAdept50 "Adept Restoration" [PERK:000C44C8]' then Spell_School_Skill_List.Add(IntToHex(FixedFormID(spell), 8) + ';Restoration;50;' + GetElementEditValues(spell, 'FULL'));
				if GetElementEditValues(spell, 'SPIT\Half-cost Perk') = 'RestorationExpert75 "Expert Restoration" [PERK:000C44C9]' then Spell_School_Skill_List.Add(IntToHex(FixedFormID(spell), 8) + ';Restoration;75;' + GetElementEditValues(spell, 'FULL'));
				if GetElementEditValues(spell, 'SPIT\Half-cost Perk') = 'RestorationMaster100 "Master Restoration" [PERK:000C44CA]' then Spell_School_Skill_List.Add(IntToHex(FixedFormID(spell), 8) + ';Restoration;100;' + GetElementEditValues(spell, 'FULL'));
